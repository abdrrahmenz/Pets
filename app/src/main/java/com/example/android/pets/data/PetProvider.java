...
public class PetProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        //Figure if the URI Matcher can match the URI to a specific code
        ...
        // so we know what content URI the Cursor was creted for.
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        // If 1 or more rows were deleted, then notify all listeners that the data at the given URI changed
        if (rowsDeleted != 0){
            getContext().getContentResolver().notifyChange(uri,null);
        }
        return rowsDeleted;
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // Return the numbers rows updated
        return rowsUpdated;
    }
